...
{
    // Thanks to vexe! :)
    // This is a derivation with futher simplification
    ...
    {
        private int[] _Buckets, _HashCodes, _Next;
        private int _Count, _Version, _FreeList, _FreeCount;
        private TKey[] _Keys; private TValue[] _Values;

        private readonly IEqualityComparer<TKey> _Comparer;

        // Mainly for debugging purposes - to get the key-value pairs display
        public System.Collections.Generic.Dictionary<TKey, TValue> AsDictionary
        {
            get { return new System.Collections.Generic.Dictionary<TKey, TValue>(this); }
        }
        ...
        {
            int index = FindIndex(key);
            return index >= 0 ? _Values[index] : default(TValue);
        }
        ...
        private static class PrimeHelper
        {
            public static readonly int[] Primes = new int[]
            {
                ...
                14591, 17519, 21023, 25229, 30293, 36353, 43627, 52361, 62851, 75431, 90523, 108631, 130363, 156437,
            ...
            {
                int num = 2 * oldSize;
                return num > 2146435069 && 2146435069 > oldSize ? 2146435069 : GetPrime(num);
            }
        }

        public ICollection<TKey> Keys { get { return _Keys.Take(Count).ToArray(); } }

        public ICollection<TValue> Values { get { return _Values.Take(Count).ToArray(); } }
